-- ============================================================
-- JUARA RATECARD - CLEAN RESET & SETUP
-- ============================================================

-- 1. DROP EXISTING TABLES (Clean Slate)
DROP TABLE IF EXISTS quotation_revision_log CASCADE;
DROP TABLE IF EXISTS quotation_status_log CASCADE;
DROP TABLE IF EXISTS quotation_line CASCADE;
DROP TABLE IF EXISTS quotation CASCADE;
DROP TABLE IF EXISTS rate_card_line CASCADE;
DROP TABLE IF EXISTS rate_card CASCADE;
DROP TABLE IF EXISTS master_item_variant CASCADE;
DROP TABLE IF EXISTS master_item CASCADE;
DROP TABLE IF EXISTS master_subcategory CASCADE;
DROP TABLE IF EXISTS master_category CASCADE;
DROP TABLE IF EXISTS master_client CASCADE;
DROP TABLE IF EXISTS master_vendor CASCADE;
DROP TABLE IF EXISTS master_zone CASCADE;
